...
SYSTEM_PROMPT = (
    ...
    "candidate's CV with the job description. Respond ONLY with a JSON object "
    'with exactly two keys: "score" (an integer 0-100 representing how well the '
    'candidate matches the role) and "reason" (a brief explanation, max 100 '
